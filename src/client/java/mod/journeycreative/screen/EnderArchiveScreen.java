...
public class EnderArchiveScreen extends ForgingScreen<EnderArchiveScreenHandler> {
    ...
    private static final Identifier EMPTY_SLOT_RESEARCH_VESSEL_TEXTURE = Identifier.of(Journeycreative.MOD_ID, "container/slot/research_vessel");
    private static final Identifier EMPTY_SLOT_RESEARCH_CERTIFICATE_TEXTURE = Identifier.of(Journeycreative.MOD_ID, "container/slot/research_certificate");
    ...
    protected void drawInvalidRecipeArrow(DrawContext context, int x, int y) {
        if (this.getScreenHandler().hasInvalidRecipe()) {
            context.drawGuiTexture(RenderPipelines.GUI_TEXTURED, ERROR_TEXTURE, this.x + 74,this.y + 31, 28, 21);
        }
    }
